...
GREP_FILE_HIGHLIGHT = 'highlight default link deniteSource_grepFile Directory'
...
class Source(Base):
    ...
    def define_syntax(self):
        ...
        self.vim.command(r'syntax match deniteSource_grep       /^.*$/ containedin=' + self.syntax_name + ' '
                         r'contains=deniteSource_grepHeader,deniteSource_grepFile,deniteSource_grepLineNR,deniteMatchedRange')
        self.vim.command(r'syntax match deniteSource_grepHeader /\v[^:]*:\d+(:\d+)? / contained keepend')
        self.vim.command(r'syntax match deniteSource_grepFile   /[^:]*:/              contained ')
        self.vim.command(r'syntax match deniteSource_grepLineNR /\d\+\(:\d\+\)\?/     contained ')
        # self.vim.command(
    ...
    def highlight(self):
        ...
        self.vim.command('highlight default link deniteSource_grepFile   Directory')
        self.vim.command('highlight default link deniteSource_grepLineNR Number')
        self.vim.command('highlight default link deniteGrepPatterns      Function')
